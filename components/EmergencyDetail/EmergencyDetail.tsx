...
export default function EmergencyDetail({
  ...
  const typeColor =
    typeColorMap[emergency.type as keyof typeof typeColorMap] ||
    "bg-gray-100 text-gray-700";
  const severityColor =
    severityColorMap[emergency.severity as keyof typeof severityColorMap] ||
    "bg-gray-100 text-gray-700";
  ...
  return (
    <div className="bg-white rounded-lg shadow-md h-full flex flex-col overflow-hidden">
      ...
      <div className="p-4 flex gap-2 flex-wrap border-b">
        <span
          className={`text-sm font-medium px-3 py-1 rounded-full ${typeColor}`}
        >
          {emergency.type}
        </span>
        <span
          className={`text-sm font-medium px-3 py-1 rounded-full ${severityColor}`}
        >
      ...
      <div className="overflow-y-auto flex-1">
        ...
        <div className="p-5 border-b">
          ...
          <div className="p-4 border-t flex gap-3">
            <button className="flex-1 flex items-center justify-center gap-2 py-3 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-lg transition-colors">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
